...
11. 🟡 Q4 brightness — Q4a backlight subsystem, Q4b manager algebra and Q4c-1 the QS slider are
    done; Q4c-2 (per-monitor card) and Q4d (keys/OSD/`Shell.Brightness`) remain. Plan file:
