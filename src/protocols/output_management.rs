...
use synoik_config::{FloatOrInt, OutputName, Vrr};
use synoik_ipc::Transform;
...
pub struct OutputManagementManagerState {
    ...
    current_state: HashMap<OutputId, synoik_ipc::Output>,
    current_config: synoik_config::Outputs,
}
...
enum OutputConfigurationState {
    Ongoing(HashMap<OutputId, synoik_config::Output>),
    Finished,
}
...
impl OutputManagementManagerState {
    ...
    pub fn on_config_changed(&mut self, new_config: synoik_config::Outputs) {
        self.current_config = new_config;
    }

    pub fn notify_changes(&mut self, new_state: HashMap<OutputId, synoik_ipc::Output>) {
                ...
                match new_config.entry(*output) {
                    ...
                    Entry::Vacant(entry) => {
                        ...
                        let mut config = g_state
                            ...
                            .find(&name)
                            .cloned()
                            .unwrap_or_else(|| synoik_config::Output {
    ...
    fn request(
        ...
        match request {
            zwlr_output_configuration_head_v1::Request::SetMode { mode } => {
                ...
                new_config.mode = Some(synoik_config::output::Mode {
                    custom: false,
            ...
            zwlr_output_configuration_head_v1::Request::SetPosition { x, y } => {
                new_config.position = Some(synoik_config::Position { x, y });
            }
