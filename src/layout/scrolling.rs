...
use synoik_config::{CenterFocusedColumn, PresetSize, Struts};
use synoik_ipc::{ColumnDisplay, SizeChange, WindowLayout};
...
impl<W: LayoutElement> ScrollingSpace<W> {
    ...
    fn activate_column_with_anim_config(&mut self, idx: usize, config: synoik_config::Animation) {
    ...
    pub fn add_tile(
        ...
        width: ColumnWidth,
        is_full_width: bool,
        anim_config: Option<synoik_config::Animation>,
    ) {
    ...
    pub(super) fn insert_hint_area(
        ...
        let mut hint_area = match position {
            ...
            InsertPosition::EdgeTile(_) => return None,
        };
    ...
    /// Returns the geometry of the active window relative to the view, *unclamped*.
    ///
    ...
    pub fn active_window_visual_rectangle(&self) -> Option<Rectangle<f64, Logical>> {
        ...
        view.intersection(self.active_window_rectangle()?)
    }
